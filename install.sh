...
setupdockercompose () {
    ...
    mkdir -p /opt/docker
    cd /opt/docker
    wget -q -O- https://gitlab.zenterprise.org/hthighway/cdn-node-create/-/raw/main/docker-compose.yml
}
...
setuptraefikfolder () {
    ...
    mkdir -p /opt/traefik
    cd /opt/traefik
    wget -q -O- https://gitlab.zenterprise.org/hthighway/cdn-node-create/-/raw/main/dynamic.yml
}
